...
from config import DEFAULT_PDF_DIR, SYSTEM_TITLE, WINDOW_SIZE, LOG_LIST_MAX_WIDTH_OFFSET
...
class WeChatSpiderUI(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.spider_runner = WeChatSpiderRunner()  # 初始化爬虫核心
